...
var metadata_lookup = {
	'src/routes/__layout.svelte': {
		entry: '/./_app/pages/__layout.svelte-63a144e5.js',
		css: ['/./_app/assets/pages/__layout.svelte-07c8066d.css'],
		js: ['/./_app/pages/__layout.svelte-63a144e5.js', '/./_app/chunks/vendor-ba540998.js'],
		styles: null
	},
	'.svelte-kit/build/components/error.svelte': {
		entry: '/./_app/error.svelte-fdea940b.js',
		css: [],
		js: ['/./_app/error.svelte-fdea940b.js', '/./_app/chunks/vendor-ba540998.js'],
		styles: null
	},
	'src/routes/index.svelte': {
		entry: '/./_app/pages/index.svelte-4b3b6e35.js',
		css: [],
		js: ['/./_app/pages/index.svelte-4b3b6e35.js', '/./_app/chunks/vendor-ba540998.js'],
		styles: null
	}
};
...
var css$1 = {
	code:
		'img.svelte-1p8zck6{opacity:0;transition:opacity 300ms ease-out}img.loaded.svelte-1p8zck6{opacity:1}',
...
var Image = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	return `<img${add_attribute('src', src2, 0)}${add_attribute('alt', alt2, 0)} class="${[
		'svelte-1p8zck6',
		loaded ? 'loaded' : ''
	]
		.join(' ')
...
var Header = create_ssr_component(($$result, $$props, $$bindings, slots) => {
	...
	$$result.css.add(css);
	return `<header class="${'svelte-qu99jg'}">${validate_component(Image, 'Image').$$render(
		$$result,
		{ alt, src: src2 },
		{},
		{}
